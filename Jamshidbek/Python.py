...
class Car:
    def __init__(self, car_type, model, color, final_price):
    ...
    def __str__(self):
        return (f"Car Type: {self.car_type}\n"
                ...
                f"Base Price: ${self.model.base_price}\n"
...
class CarDealership:
    ...
    def confirm_selection(self):
        ...
        if choice == 'yes':
            self.selected_car = Car(self.car_type, self.model, self.color, final_price)
...
def main():
    ...
    dealership.select_car_type()  # User selects car type
    dealership.select_car_model()  # User selects model based on car type
    dealership.select_color()  # User selects color
    
    dealership.confirm_selection()  # User confirms the selection
    dealership.complete_purchase()  # Finalize the purchase
